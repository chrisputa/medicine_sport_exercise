...
Approximate diurnal pattern of variables relevant to exercise prescription. Values are population averages; individual chronotype shifts the curves.
</Fragment>
</Table>
...
<Fragment slot="caption">
HIIE counter-strategy to sleep loss (adapted from [3]).
</Fragment>
</Table>
