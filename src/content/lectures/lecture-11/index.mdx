...
Exercise prescription during acute IBD flares. Synthesised from the IBD-exercise literature (Lecture 10).
</Fragment>
</Table>
...
<Fragment slot="caption">
Moderate-intensity continuous exercise prescription in IBD remission.
</Fragment>
</Table>
...
<Fragment slot="caption">
Vigorous interval prescription in IBD remission.
</Fragment>
</Table>
...
<Fragment slot="caption">
Worked weekly exercise programme for a stable-remission IBD patient.
</Fragment>
</Table>
...
<Fragment slot="caption">
Worked weekly exercise programme during recovery from a mild flare.
</Fragment>
</Table>
...
14. Reproduce the five-step decision algorithm from Section 7.
