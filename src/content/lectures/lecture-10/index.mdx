...
Matching exercise prescription to IBD disease state (synthesised from [2] and Lecture 11).
</Fragment>
</Table>
...
<Fragment slot="caption">
Indicative correlation patterns between cytokine/SCFA biomarkers and patient-reported outcomes in IBD exercise studies (representative; magnitudes depend on study) [2].
</Fragment>
</Table>
